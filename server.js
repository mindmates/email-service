...
//Handlers for routes
require("./server/routes/account")(app, config);
require("./server/routes/email")(app, config);
require("./server/routes/mailConfig")(app, config);
require("./server/routes/template")(app, config);
